...
<!-- jQuery UI 1.11.4 -->
<script src="{{ asset("public/bower_components/admin-lte/plugins/jquery-ui/jquery-ui.min.js") }}"></script>
...
<!-- Sparkline -->
<script src="{{ asset("public/bower_components/admin-lte/plugins/sparklines/sparkline.js") }}"></script>
<!-- JQVMap -->
<script src="{{ asset("public/bower_components/admin-lte/plugins/jqvmap/jquery.vmap.min.js") }}"></script>
<script src="{{ asset("public/bower_components/admin-lte/plugins/jqvmap/maps/jquery.vmap.usa.js") }}"></script>
<!-- jQuery Knob Chart -->
<script src="{{ asset("public/bower_components/admin-lte/plugins/jquery-knob/jquery.knob.min.js") }}"></script>
<!-- daterangepicker -->
...
<script src="{{ asset("public/bower_components/admin-lte/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js") }}"></script>
<!-- Summernote -->
...
<script src="{{ asset("public/bower_components/admin-lte/dist/js/pages/dashboard.js") }}"></script>
